        ...
        public override void OnInspectorGUI()
        {
            ...
            if (animator.Animations != null)
            {
                for (int i = 0; i < animator.Animations.Length; i++)
                {
                    ...
                    if (animator.Animations[i].AnimationType == UIAnimator.EAnimationType.MOVETO_2 || animator.Animations[i].AnimationType == UIAnimator.EAnimationType.LOCALMOVETO_3)
                    {
                    ...
                    if (animator.Animations[i].AnimationType == UIAnimator.EAnimationType.SCALETO_4)
                    {
                    ...
                    animator.Animations[i].CanPlayOnPause = EditorGUILayout.Toggle("Can Play On Pause", animator.Animations[i].CanPlayOnPause);

                    if (animator.Animations[i].AnimationType == UIAnimator.EAnimationType.COLORTO_5)
                    {
                        animator.Animations[i].TargetColor = EditorGUILayout.ColorField("Target Color", animator.Animations[i].TargetColor);
                    }

                    if (animator.Animations[i].AnimationType == UIAnimator.EAnimationType.IDLE_INFINITE_6)
                    {
                    ...
                    if (animator.Animations[i].AnimationType == UIAnimator.EAnimationType.BOBBING_ONCE_7)
                    {
